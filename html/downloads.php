...
<html lang="en">
  ...
  <body>
    <audio
      id="buzzer"
      src="./Are Bhai Bhai Bhai - Meme Template.mp3"
      type="audio/mpeg"
    ></audio>
    <nav>
      <div class="nfHeader">
        <div class="nfHeader_left">
          ...
          <p>Home</p>
          <p>
            <a style="text-decoration: none; color: white" href="subs.html"
              >Subscription</a
            >
          </p>
          <p>
            <a style="text-decoration: none; color: white" href="watchList.html"
              >Watch List</a
            >
          </p>
          <p>
            <a style="text-decoration: none; color: white" href="downloads.html"
              >Downloads</a
            >
          </p>
        </div>
...
// Create connection
$conn = new mysqli($servername, $username, $password,"netflix");
